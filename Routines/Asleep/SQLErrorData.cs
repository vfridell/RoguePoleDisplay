...
namespace RoguePoleDisplay.Routines
{
    ...
    {
        public static Dictionary<string, string> SQLErrors = new Dictionary<string, string>()
        {
...
{"-148","HE SOURCE TABLE OR TABLESPACE source-name CANNOT BE ALTERED, REASON reason-code"},
...
{"-206","bject-name IS NOT VALID IN THE CONTEXT WHERE IT IS USED"},
...
{"-356","EY EXPRESSION expression-number IS NOT VALID, REASON CODE = reason-code"},
